# Daily-Bonus
## 原始项目说明
本项目签到基于 [Daily-Bonus](https://github.com/jckling/Daily-Bonus) 进行修改使用，感谢原作者 jckling。
t00ls脚本基于 [Auto-sign-in-T00ls.net](https://github.com/raddyfiy/Auto-sign-in-T00ls.net) 进行修改使用，感谢原作者raddyfiy。
